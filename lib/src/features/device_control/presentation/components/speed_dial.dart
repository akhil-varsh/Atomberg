          ...
          return GestureDetector(
            ...
            child: CustomPaint(
              ...
              painter: _SpeedRingPainter(
                speed: currentSpeed,
                color: Theme.of(context).colorScheme.primary, // Use colorScheme for consistency
                trackColor: Theme.of(context).colorScheme.onSurface.withValues(alpha: 0.1), // Adaptive track
              ),
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    .animate(
                      ...
                      onPlay: (controller) => isPowerOn ? controller.repeat() : controller.stop(),
                    )
                    .rotate(duration: _getRotationDuration(), curve: Curves.linear),
                    ...
                    const Text('SPEED', style: TextStyle(fontSize: 14, letterSpacing: 3)),
                  ],
                ),
              ),
            ),
...
class _SpeedRingPainter extends CustomPainter {
  ...
  _SpeedRingPainter({required this.speed, required this.color, required this.trackColor});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paintMock.shader = gradient.createShader(Rect.fromCircle(center: center, radius: radius));
